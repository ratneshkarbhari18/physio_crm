        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row">
                        <form action="functions/export-bank.php" id="exportBankForm">            
                        <div class="col-md-12">
                            <div class="card">
                                <div class="row">
                                    <div class="col-md-4">
                                ...
                                <div class="card-body table-full-width">
                                    ...
                                    <table id="bootstrap-table" class="table">
                                        <thead>
                                            ...
                                            <th data-field="name" data-sortable="true">Name Of AC Holder</th>
                                            <th data-field="number">AC No</th>
											<th data-field="bname">Bank & Branch Name</th>
                                            <th data-field="name1">IFSC Code</th>
...
<script type="text/javascript">
    ...
    $("#exportBankForm").submit(function(e) {
