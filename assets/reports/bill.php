                            ...
                            <div class="card bootstrap-table">
                                <div class="card-body table-full-width">
                                    ...
                                    <table id="bootstrap-table" class="table">
                                        ...
                                        <tbody>
                                            <?php
                                                $query = "SELECT r.id,r.p_id,r.base_treatment,r.treatments,p.fname,p.lname,r.pay_time FROM patients p, reports r WHERE r.p_id=p.id AND paid=1 ORDER BY r.id DESC";
