        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row">
                        <form action="functions/export-outstanding.php" id="exportOutstandingForm">            
                        <div class="col-md-12">
                            <div class="card">
                                <div class="row">
                                    <div class="col-md-4">
                            ...
                            <div class="card bootstrap-table">
                                <div class="card-body table-full-width">
                                    ...
                                    <table id="bootstrap-table" class="table">
                                        <thead>
                                            <th data-field="receipt-no" data-sortable="true" class="text-center">Receipt No.</th>
                                            <th data-field="name" data-sortable="true">Name Of Patients</th>
                                            <th data-field="type">Date Of Treatment</th>
                                            <th data-field="amount">Ageing</th>
                                        </thead>
                                        <tbody>
                                            <?php
                                                $query = "SELECT r.id, p.fname, p.lname, r.time_stamp, DATEDIFF(NOW(), r.time_stamp) AS age FROM reports r, patients p WHERE paid=0 AND r.p_id=p.id ORDER BY r.id DESC ";
...
<script>
    $("#nav-outstanding").addClass("active");
</script>
...
<script type="text/javascript">
    ...
    $("#exportOutstandingForm").submit(function(e) {
