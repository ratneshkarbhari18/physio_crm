...
if(check()){
	...
	$date = $_POST['date'];
	$query = "INSERT INTO reports(p_id,base_treatment,treatments,r_doc_id,doc_id,doc_present,other) VALUES($p_id,'$base','$treatments',$r_doc_id,$doc_id,$doc_present,'$other')";
	//var_dump($query);
