...
if(check()){
    ...
    $query = "INSERT INTO patients(fname,lname,dob,gender,aadhaar,address,phone,r_phone,pincode,location,CO,HO,MHO,IX,tri) VALUES('$fname','$lname','$dob','$gender','$aadhaar','$address','$phone','$r_phone','$pincode','$location','$co','$ho','$mho','$ix','$tri')";
