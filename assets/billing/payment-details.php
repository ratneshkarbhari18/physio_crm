...
if(isset($_GET['id'])){
    $id = $_GET['id'];
    $query = "SELECT * FROM reports WHERE id=$id AND paid=b'0' AND pay_time IS NULL";
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="content">
                                            <form action="pay.php?id=<?php echo $id?>" method="POST">
                                                ...
                                                <br>
                                                <label>Amount: <?php echo $total?></label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" required="" name="donation" min="0" value="0" class="form-control" >
                                                </div>
                                                <div id="cheque">
                                                    <div class="form-group">
