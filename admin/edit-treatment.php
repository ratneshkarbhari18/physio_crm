                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card stacked-form">
                                ...
                                <div class="card-body ">
                                    <form action="functions/edit-treatment.php" id="editPatientForm">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="cost" value="<?php echo $row['amount']?>" name="cost" class="form-control" >
                                        </div>
                                        <div class="form-group">
                                            <label>Treatment Max-Time</label>
                                            <input type="number" value="<?php echo $row['max_time']?>" name="max" class="form-control" >
                                        </div>
                                        <div class="form-group">
                                            <label>Treatment Min-Time</label>
                                            <input type="number" value="<?php echo $row['min_time']?>" name="min" class="form-control" >
                                        </div>
