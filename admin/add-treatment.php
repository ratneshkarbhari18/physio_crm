                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card stacked-form">
                                ...
                                <div class="card-body ">
                                    <form action="functions/add-treatment.php" id="addTreatmentForm">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="cost" required="" name="cost" class="form-control" >
                                        </div>
                                        <div class="form-group">
                                            <label>Treatment Max-Time</label>
                                            <input type="number" required="" name="max" class="form-control" >
                                        </div>
                                        <div class="form-group">
                                            <label>Treatment Min-Time</label>
                                            <input type="number" required="" name="min" class="form-control" >
                                        </div>
