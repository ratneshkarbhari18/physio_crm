                        ...
                        <div class="col-md-6">
                            <div class="card stacked-form">
                                <div class="card-header ">
                                    <h4 class="card-title">Add Refered Dr</h4>
                                </div>
                                
                                <div class="card-body ">
                                    <form action="functions/add-reff-dr.php" method="post" id="addPatientForm">
                                        ...
                                        <div class="form-group">
										 ...
										 <div class="form-group" >
                                            ...
                                            <input type="number" required=""   pattern="\d{10,10}" title="Enter valid 10 digit phone number" name="phone" class="form-control" >
                                        </div>
                                        <div class="form-group">
                                                <label>Address</label>
        ...
        $.ajax({
                ...
                success: function(data)
                {
                    ...
                    if(obj.success){
                        ...
                        icon = "nc-check-2";
                        func = function(){
                                window.location.href = 'refering-dr.php'; 
                            }
                    }
