                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card stacked-form">
                                ...
                                <div class="card-body ">
                                    <form action="functions/add-salary.php" id="addSalaryForm">
                                        ...
                                        <div class="form-group">
                                            <label>Month</label>
                                            <select required="" data-title="Select Month" name="month" class="selectpicker" data-style="btn-success btn-fill" data-menu-style="dropdown-green">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" required="" name="gross" class="form-control" >
                                        </div>
