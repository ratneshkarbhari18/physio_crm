        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row">
                        <form action="functions/export-salary.php" id="exportSalaryForm">            
                        <div class="col-md-12">
                            <div class="card">
                                <div class="row">
                                    <div class="col-md-4">
                                ...
                                <div class="card-body table-full-width">
                                    ...
                                    <table id="bootstrap-table" class="table">
                                        <thead>
                                            ...
                                            <th data-field="gross">Gross Salary</th>
                                            <th data-field="net">Net Salary</th>
											<th data-field="adv">Advance</th>
											<th data-field="ptype">Payment Type</th>
											<th data-field="pdet">Details</th>
                                        </thead>
                                        <tbody>
                                            <?php
                                                $query = "SELECT * FROM staffsal order by id DESC";
                                                $res = mysqli_query($conn,$query);
                                                while ($row = mysqli_fetch_assoc($res)) {
                                                    $pt=json_decode($row['mode'],true);
                                            ?>
                                            <tr>
                                                ...
                                                <td><?php echo $row['gs'].' Rs'?></td>
                                                <td><?php echo $row['ns'].' Rs'?></td>
												<td><?php echo $row['advan'].' Rs'?></td>
												<?php
                                                    echo "<td>".$pt['mode']."</td>";
                                                ?>
                                                <?php if($pt['mode']=='cheque'){?>
                                                <td><?php echo "Bank Name:".$pt['bank']."<br>Cheque no.:".$pt['cheque_no']?></td>
                                                <?php } else{
                                                    echo "<td>---</td>";
                                                }?>
                                            </tr>
...
<script type="text/javascript">
    ...
    $("#exportSalaryForm").submit(function(e) {
