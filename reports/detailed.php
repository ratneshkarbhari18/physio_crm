        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row">
                        <form action="functions/export-detail.php" id="exportBillForm">            
                        <div class="col-md-12">
                            <div class="card">
                                <div class="row">
                                    <div class="col-md-4">
                            ...
                            <div class="card bootstrap-table">
                                <div class="card-body table-full-width">
                                    ...
                                    <table id="bootstrap-table" class="table">
                                        <thead>
                                            <th data-field="docname" >Doctor Name</th>
                                            <th data-field="name">Patient Name</th>
                                            <th data-field="id" data-sortable="true">Bill Id</th>
                                            <th data-field="amount">Amount</th>
                                            <th data-field="per">% of doctor</th>
                                            <th data-field="share">Centre Shared</th>
                                            <th data-field="entry">Entry Fee</th>
                                        </thead>
                                        <tbody>
                                            <?php
                                                $query = "SELECT r.id,r.p_id,r.base_treatment,r.treatments,r.doc_id,r.covid,p.fname,p.lname,r.pay_time FROM patients p, reports r WHERE r.p_id=p.id AND paid=1 ORDER BY r.id DESC";
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $data['amount'] +$row['covid']." Rs"?></td>
                                                <td><?php echo $tp*$per." Rs" ?></td>
                                                <td><?php echo $tp -($tp*$per) +$row['covid']+25+$tef." Rs"?></td>
                                                <td><?php echo $tef." Rs"?></td>
                                            </tr>
                                            <?php
                                            $tef=0;
                                                }
                                                $sql="SELECT * FROM consultant where paid=1";
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row['id']?></td>
                                                <td><?php echo $amount + $row['covid']." Rs"?></td>
                                                <td><?php echo $tp*$per." Rs" ?></td>
                                                <td><?php echo $tp -($tp*$per)+ 25+$row['covid']." Rs"?></td>
                                                <td><?php echo "0 Rs"?></td>
                                            </tr>
                                            <?php
                                                }
