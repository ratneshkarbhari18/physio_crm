        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row">
                        <form action="functions/export-cash.php" id="exportDonationForm">            
                        <div class="col-md-12">
                            <div class="card">
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <table id="bootstrap-table" class="table">
										...
										?>
                                            <tr>
                                                ...
                                                <td><?php $op=(int)$row1['opening'];echo $row1['opening'];?> Rs</td>
                                                <td><?php include 'daily-calc.php' ?> Rs</td>
												<td><?php echo $debit; ?> Rs</td>
												<td><?php $bal=($op+$gt)-$debit; echo $bal; ?> Rs</td>
										...
										$ll=date_create($row1['date']);
                                               
											echo '<tr>
                                                <td>'.$row1['id'].'</td>
                                                <td>'.date_format($ll,"d/m/Y").'</td>
                                                <td>'.$row1['opening'].' Rs</td>
                                                <td>'.$row1['credit'].' Rs</td>
												<td>'.$row1['debit'].' Rs</td>
												<td>'.$row1['balance'].' Rs</td>';
										}echo '</tr>';}
