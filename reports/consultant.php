        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row">
                        <form action="functions/export-con.php" id="exportDonationForm">            
                        <div class="col-md-12">
                            <div class="card">
                                <div class="row">
                                    <div class="col-md-4">
                            ...
                            <div class="card bootstrap-table">
                                <div class="card-body table-full-width">
                                    ...
                                    <table id="bootstrap-table" class="table">
                                        <thead>
                                            <th data-field="receipt-no" data-sortable="true" class="text-center">Bill No.</th>
                                            <th data-field="date">Date</th>
                                            <th data-field="name" data-sortable="true">Name Of Patient</th>
                                            <!--<th data-field="type">treatment</th>-->
                                            <th data-field="doc">treated by </th>
                                            <th data-field="red">Redevelopment Fee </th>
                                        ...
                                        <tbody>
                                            <?php
                                                $query = "SELECT * FROM consultant WHERE paid=1 ORDER BY id DESC";
