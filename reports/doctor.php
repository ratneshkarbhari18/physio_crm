        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row">
                        <form action="functions/export-doctorsal.php" id="exportDoctorForm">            
                        <div class="col-md-12">
                            <div class="card">
                                <div class="row">
                                    <div class="col-md-4">
                            ...
                            <div class="card bootstrap-table">
                                <div class="card-body table-full-width">
                                    ...
                                    <table id="bootstrap-table" class="table">
                                        <thead>
                                            <th data-field="receipt-no" data-sortable="true" class="text-center">ID</th>
                                            <th data-field="name" data-sortable="true">Name Of Doctor</th>
                                            
                                            <th data-field="t-amount">Remuneration</th>
                                            <th data-field="ptype">Payment Type</th>
                                            <th data-field="pdet">Details</th>
                                            <th data-field="amount">Month</th>
                                        </thead>
                                        <tbody>
                                            <?php
												$date=date('M');
                                                $query = "SELECT * FROM docsal WHERE month='$date'";
