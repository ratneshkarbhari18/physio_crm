                                ...
                                <div class="card-body table-full-width">
                                    ...
                                    <table id="bootstrap-table" class="table">
                                        <thead>
                                            ...
                                            <th data-field="name" data-sortable="true">Name Of Donor</th>
                                            <th data-field="type">Type Of Donor</th>
                                        ...
                                        <tbody>
                                            <?php
                                                $query = "SELECT * FROM donations WHERE paid=1 ORDER BY id DESC";
                                            ...
                                            <tr>
                                                ...
                                                <?php }elseif($p['mode']=='card'){ ?>
                                                <td><?php echo "Card no.:".$p['card_no']?></td>
                                                <?php } else{
                                                    echo "<td>---</td>";
                                                }?>
                                            </tr>
