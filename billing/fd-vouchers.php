    ...
    <?php
        ...
        <div class="main-panel">
            ...
            <div class="content container">
                ...
                <?php
                $query = "SELECT * FROM fd_vouchers";
                $res = mysqli_query($conn,$query);
                ?>
                    <a href="add-new-fd-voucher.php" class="btn btn-success">+ FD Voucher</a>
                    <table id="bootstrap-table" class="table bootstrapTable" style="1px solid darkgray;">
                    <thead>
                        <th data-field="amount" data-sortable="true" class="text-center">Amount</th>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            <form action="functions/delete-fd-voucher-exe.php" method="post">
