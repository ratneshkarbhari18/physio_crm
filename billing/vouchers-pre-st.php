...
<br>
		...
		<table>
		    ...
		    <tbody>
		        <tr>
		            <td>Staff renumeration</td>
		            <td><?php echo "Rs.".$row['ns']?></td>
		            <td></td>
		        </tr>
		        <tr>
		...
		<!--<br>-->
		<!--<br>-->
		<!--<p><b>Employee Name:</b><u><?php echo "<u>".$row['name']."</u>"?></u></p>-->

		<!--<br>-->
		<!--	<p> <b>No. Of Days Present:</b><u><?php echo $row['nod']?></u></p>-->
		<!--	<br>-->
		<!--	<p> <b>Gross Salary:</b><u><?php echo "Rs.".$row['gs']?></u></p>-->
		<!--	<br>-->
		<!--	<p> <b>Net Salary:</b><u><?php echo "Rs.".$row['ns']?></u></p>-->


		<br>

		<p style="text-transform: capitalize;"><b>In Words: </b><u><?php echo getIndianCurrency($row['ns'])?></u></p>
