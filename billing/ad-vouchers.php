        ...
        <div class="main-content-area" style="width: 95%; margin: 0 auto;">
            <table id="bootstrap-table" class="table bootstrapTable">
                <thead>
                    ...
                    <th data-field="amount" data-sortable="true" class="text-center">Convection</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                        <a type="button" class="btn btn-danger"  href="edit_ad_voucher.php?id=<?php echo $row["id"]; ?>">Edit</a>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-body">
                                        <form action="functions/delete_ad_voucher.php" method="post">
