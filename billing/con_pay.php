...
if(isset($_GET['id'])){
    ...
    if(mysqli_affected_rows($conn)>0){
        ...
        $mode = $_POST["mode"];
        $p_id = mysqli_fetch_assoc($res)["id"];
		...
		$date=date("Y/m/d");
        $query = "UPDATE consultant SET paid='1', mode='$pd' WHERE id=$id";
        ...
        <div class="main-content">
            <div class="container-fluid">
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-6"><iframe id="preview" name="preview" width="100%" height="900px" src="con_bill.php?id=<?php echo $_GET['id']?>"></iframe></div>
                    <div class="col-md-3"></div>
                 </div>
