        ...
        <div class="main-content-area" style="width: 95%; margin: 0 auto;">
            <table id="bootstrap-table" class="table bootstrapTable">
                <thead>
                    ...
                    <th data-field="amount" data-sortable="true" class="text-left">Amount</th>
                    <th data-field="date" class="text-center">Date</th>
                    <th>Action</th>
                </thead>
                <tbody>
                    <?php
                        $query = "SELECT * FROM docsal";
                    ...
                    <tr>
                        ...
                        <td>
                        <a type="button" class="btn btn-danger"  href="edit_docsal_voucher.php?id=<?php echo $row["id"]; ?>">Edit</a>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-body">
                                        <form action="functions/delete_docsal_voucher.php" method="post">
...
$("li#docsal-vouchers").addClass("active");
