    ...
    <div class="main-panel">
        ...
        <div class="main-content-area" style="width: 95%; margin: 0 auto;">
            <table id="bootstrap-table" class="table bootstrapTable">
                <thead>
                    <th data-field="payee" data-sortable="true" class="text-center">Payee</th>
                    <th data-field="purpose" data-sortable="true" class="text-center">Purpose</th>
                    <th data-field="amount" data-sortable="true">Amount</th>
                    <th data-field="amount_word">Amount Word</th>
                    <th data-field="date" class="text-center">Date</th>
                    <th>Action</th>
                </thead>
                <tbody>
                    <?php
                        $query = "SELECT * FROM jv";
                    ...
                    <tr>
                        ...
                        <td>
                        <a type="button" class="btn btn-danger"  href="edit_jv_voucher.php?id=<?php echo $row["id"]; ?>">Edit</a>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-body">
                                        <form action="functions/delete_jv_voucher.php" method="post">
