<div class="container-fluid">
    <div class="row">
        <div class="col-md-7">
                                ...
                                <div class="card-body">
                                    <form class="form-horizontal " method="post" action="functions/add-ad.php" id="addadForm">
                                ...
                                <div class="card-footer ">
                                    <div class="col-md-float-right">
                                        ...
                                        <button type="button" onclick="window.location='preview_voucher.php?s=ad';"  id="print6" disabled="true"  class="btn btn-fill btn-info" style="background-color:#17a2b8;cursor: not-allowed;">Print</button>
                                        </center>
                                    </div>
                                </div>
								</form>
