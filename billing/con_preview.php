...
if(isset($_GET['id'])){
    $id = $_GET['id'];
    $query = "SELECT * FROM consultant WHERE id=$id AND paid=b'1'";
        ...
        <div class="main-content">
            <div class="container-fluid">
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-6"><iframe id="preview" name="preview" width="100%" height="800px" src="con_bill.php?id=<?php echo $_GET['id']?>"></iframe></div>
                    <div class="col-md-3"></div>
                 </div>
