...
$query="select * from docsal order by id DESC";
...
<html>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <br>
		...
		<table>
		    <thead>
		        <th>Details of expences</th>
		        <th>Rupees</th>
		        <th>Paise</th>
		    </thead>
		    <tbody>
		        <tr>
		            <td>Doctor renumeration</td>
		...
		<!--    <tr>-->
		<!--        <td style="width:202px;"><b>Doctor's Name:</b></td>-->
		<!--        <td style="border-bottom:1px solid #000000;"><?php echo "Dr.".$row['name']?></td>-->
		<!--    </tr>-->
		<!--    <tr>-->
		<!--        <td style="width:202px;"><b>Patients Treated:</b></td>-->
		<!--        <td style="border-bottom:1px solid #000000;"><?php echo $row['nop']?></td>-->
		<!--    </tr>-->
		<!--    <tr>-->
		<!--        <td style="width:202px;"><b>Amount:</b></td>-->
		<!--        <td style="border-bottom:1px solid #000000;"><?php echo "Rs.".$row['amount']?></td>-->
		<!--    </tr>-->
		<!--    <tr>-->
