        ...
        <div class="main-content-area" style="width: 95%; margin: 0 auto;">
            <table id="bootstrap-table" class="table bootstrapTable">
                <thead>
                    ...
                    <th data-field="ns" data-sortable="true" class="text-center">NS</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                        <!-- <a type="button" class="btn btn-danger"  href="edit_staff_sal_voucher.php?id=<?php echo $row["id"]; ?>">Edit</a> -->
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-body">
                                        <form action="functions/delete_staff_sal_voucher.php" method="post">
...
$("li#staff-sal-vouchers").addClass("active");
