        ...
        <div class="main-content-area" style="width: 95%; margin: 0 auto;">
            <table id="bootstrap-table" class="table bootstrapTable">
                <thead>
                    ...
                    <th data-field="purpose" class="text-center">Purpose</th>
                    <th data-field="vdate" class="text-center">VDate</th>
                    <th>Action</th>
                </thead>
                <tbody>
                    <?php
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?php echo $row["vdate"]; ?></td>
                        <td>
                        <a type="button" class="btn btn-danger"  href="edit_bank_voucher.php?id=<?php echo $row["id"]; ?>">Edit</a>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-body">
                                        <form action="functions/delete_bank_voucher.php" method="post">
...
$("li#bank-vouchers").addClass("active");
