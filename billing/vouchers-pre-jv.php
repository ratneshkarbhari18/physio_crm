...
<html>
    ...
    <br>
		...
		<br>
        <br>
		<p><b>Name of person:</b><u><?php echo $row['payee']?></u></p>
		<br>
		...
		<!--<p><b>Payable To:</b><u><?php echo "<u>".$row['payee']."</u>"?></u></p>-->

		<!--<br>-->
		<!--	<p> <b>Purpose:</b><u><?php echo $row['purpose']?></u></p>-->
		<!--	<br>-->
		...
		<!--<p class="left"><b>Reciever Sign</b></p>-->
		<!--<p class="left"><b>Auditor Sign</b></p>-->
		<!--<p class="right"><b>Treasurer Sign</b></p>-->
		<!--<p class="right"><b>Secretary Sign</b></p>-->
