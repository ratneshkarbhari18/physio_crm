...
<html>
    ...
    <br>
		...
		<br>
		<br>
		<p><b>Name of person:</b><u><?php echo $row['convection']?></u></p>
		<br>
		<table>
		    <thead>
		...
		<!--<p><b>Expense Type:</b><u><?php echo $row['type']?></u></p>-->

		<!--<br>-->
		<!--	<p> <b>Convection:</b><u><?php echo $row['convection']?></u></p>-->
		<!--	<br>-->
		<!--	<p> <b>Narration:</b><u><?php echo $row['narration']?></u></p>-->
		<!--	<br>-->
		...
		<!--<p class="left"><b>Auditor</b></p>-->
		<!--<p class="right"><b>Treasurer</b></p>-->
		<!--<p class="right"><b>Secretary</b></p>-->
