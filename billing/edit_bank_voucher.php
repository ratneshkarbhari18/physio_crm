...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        <div class="main-content-area" style="width: 95%; margin: 0 auto;">
            <form action="functions/update_bank_voucher.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input value="<?php echo $vdate; ?>" type="text" name="vdate" id="vdate" class="form-control">
                </div>
                <div class="form-group">
