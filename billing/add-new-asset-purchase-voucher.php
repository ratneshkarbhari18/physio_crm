...
$title = "Add New Asset Purchase Voucher";

$query="select id from asset_purchase_vouchers order by id DESC;";
    ...
    <?php
        ...
        <div class="main-panel">
            ...
            <div class="content container">                        
                ...
                <form action="functions/add-asset-purchase-voucher-exe.php" method="post">
                    ...
                    <button type="submit" class="btn btn-success">Add Purchase Voucher</button><br>
                </form>
