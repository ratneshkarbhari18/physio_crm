...
<br>
		...
		<!--<p><b>Description:</b><u><?php echo "<u>".$row['des']."</u>"?></u></p>-->

		<!--<br>-->
		<!--	<p> <b>Amount:</b><u><?php echo "Rs.".$row['cost']?></u></p>-->
		<!--	<br>-->

		<!--<p style="text-transform: capitalize;"><b>In Words: </b><u><?php echo getIndianCurrency($row['cost'])?></u></p>-->
