...
$title = "Consultant Current Bills";
?>
<!doctype html>
<html lang="en">
<head>
                                        ...
                                        <div class="card bootstrap-table">
                                            <div class="card-body table-full-width">
                                                ...
                                                <table id="bootstrap-table" class="table">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            $query = "SELECT * FROM consultant WHERE paid=b'0'";
                                                        ...
                                                        <tr>
                                                            ...
                                                            <form action="delete_cons_bill.php" method="post">
...
<script>
function pay(id){
	location.href="con_payment-details.php?id="+id;
}
</script>
