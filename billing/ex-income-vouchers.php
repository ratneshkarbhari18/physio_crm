    ...
    <div class="main-panel">
        ...
        <div class="main-content-area" style="width: 95%; margin: 0 auto;">
            <table id="bootstrap-table" class="table bootstrapTable">
                <thead>
                    <th data-field="name" data-sortable="true" class="text-center">Type</th>
                    <th data-field="des" data-sortable="true" class="text-center">Description</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                        <a type="button" class="btn btn-danger"  href="edit_ex_income_voucher.php?id=<?php echo $row["id"]; ?>">Edit</a>
...
$("li#ex-income-vouchers").addClass("active");
