...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        $query = "SELECT * FROM docsal WHERE id=$id";
        ...
        <div class="main-content-area" style="width: 95%; margin: 0 auto;">
            <form action="functions/update_docsal_voucher.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <input value="<?php echo $month; ?>" type="text" name="month" id="month" class="form-control">
                </div>
                <div class="form-group">
