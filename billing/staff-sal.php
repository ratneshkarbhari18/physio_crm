...
<div class="container-fluid mt-60" id="staff">
    <div class="container-fluid">
    <div class="row">        
        <div class="col-md-7">
                                ...
                                <div class="card-body">
                                    <form class="form-horizontal " action="functions/add-staffsal.php" id="addStaffsalForm">
									   ...
									   <div class="form-group">
                                            <div class="row">
                                                <label class="col-md-3 control-label">Advance amount</label>
                                                <div class="col-md-9">
                                                    <input type="number" name="adm" placeholder="amount" value="0" required="" class="form-control">
                                                </div>
                                            </div>
                                       </div>
									   <div class="form-group">
