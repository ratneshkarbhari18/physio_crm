                            ...
                            <div class="card bootstrap-table">
                                <div class="card-body table-full-width">
                                    ...
                                    <table id="bootstrap-table" class="table">
                                        <thead>
                                            <th data-field="id" data-sortable="true" class="text-center">Sr.No</th>
                                            <th data-field="name" data-sortable="true" class="text-center"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Patient Name </th>
                                            <!--<th data-field="treament" data-sortable="true">Treatment Given</th>-->
                                        ...
                                        <tbody>
                                            <?php
                                                include '../includes/db.php';
                                                $query = "SELECT * FROM consultant where doc_id=".$_SESSION['doctor_id']." ORDER BY id ASC";
