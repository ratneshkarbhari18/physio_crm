...
<body>
    <div class="wrapper">
        ...
        <div class="main-panel">
                                ...
                                <div class="card-body ">
                                    <form action="functions/add-patient.php" id="addPatientForm">
                                        ...
                                        <div class="form-group">
                                            <label>Patient Name<sup style="color:#ff0000;font-size:15px;">*</sup></label>
                                            <input type="text" required="" name="name" class="form-control" >
                                        </div>
                            
                                        <!--<div class="form-group">-->
                                        <!--    <label>Treatment Given<sup style="color:#ff0000;font-size:15px;">*</sup></label>-->
                                        <!--    <input type="text" required="" name="treat" class="form-control" >-->
                                        <!--</div>-->
										<div class="form-group">
                                            <label>Consultant Fee<sup style="color:#ff0000;font-size:15px;">*</sup></label>
           ...
           <!--                                         <select required="" data-title="Select Payment Mode" id="mode1" name="mode" class="selectpicker" data-style="btn-info btn-fill" data-menu-style="dropdown-blue">-->
