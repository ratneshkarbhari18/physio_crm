...
<body>
    <div class="wrapper wrapper-full-page">
        <div class="full-page  section-image" data-color="black" data-image="../assets/img/sidebar-5.jpg" ;>
            <div class="content">
              <center>
                ...
                <div class="container">
                    <div class="col-md-4 col-sm-6 ml-auto mr-auto">
                        <form class="form" id="loginForm" action="functions/login.php" method="POST">
                            <div class="card card-login card-hidden">
                                <div class="card-header ">
                                    <h3 class="header text-center">Doctor Login</h3>
                                </div>
                                <div class="card-body ">
                                    <div class="card-body">
    ...
    $(document).ready(function() {
        ...
        setTimeout(function() {
            ...
            <?php
                if(isset($_GET['msg'])){
                    $msg = $_GET['msg'];
                    echo "showNotification('danger','nc-notification-70','$msg')";
                }
            ?>
        }, 700);
