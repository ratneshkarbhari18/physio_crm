<?php
    ...
    $id = $_GET['id'];
    $sql = "SELECT fname,lname,gender, age FROM patients WHERE id=$id";
                                ...
                                <div class="card-body table-full-width">
                                    ...
                                    <table id="bootstrap-table" class="table">
                                        <thead>
											...
											<th data-field="other">Backup</th>
                                            <th data-field="gender">Date</th>
                                            <th data-field="action"></th>
                                        </thead>
                                        <tbody>
                                            <?php
                                                $query = "SELECT r.id,r.base_treatment,r.doc_present,r.other,r.treatments,r.time_stamp,d.name FROM reports r, users d WHERE r.doc_id=d.id AND p_id=$id ORDER BY r.time_stamp DESC";
                                            ...
                                            <tr>
                                                ...
                                                <td><button id="lmn" name="functions/add_from_his.php?id=<?php echo $row['id']?>"  class="btn btn-danger btn-wd">Add to billing
                                                </button></td>
                                            </tr>
                                            <?php
                                                }
									...
									<div class="toolbar1" style="margin: 14px 98px;text-align:end;">
                                        <button onclick="window.location.href='preview.php?id=<?php echo $id?>'" class="btn btn-danger btn-wd">
                                            Print
                                        </button>
                                    </div>
                                </div>
