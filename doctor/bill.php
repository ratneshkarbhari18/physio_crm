...
<table border=0>
<?php
$query = "SELECT r.id,r.base_treatment,r.treatments,r.time_stamp,d.name FROM reports r, users d WHERE r.doc_id=d.id AND p_id=$id ORDER BY r.time_stamp DESC LIMIT 1";
