...
if(check()){
	...
	$mode ='{"mode":"cash"}';
	$query = "INSERT INTO reports(p_id,base_treatment,treatments,r_doc_id,doc_id,doc_present,other,covid,time_stamp,paid,pay_time,payment_details) VALUES($p_id,'$base','$treatments','$r_doc_id','$doc_id',1,'$other',10,'$dateTimeStamp',1,'$date','$mode')";
