            ...
            <div class="content container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 text-left">
                        <form action="search_patients_exe.php" method="post">
                            <div class="form-group">
                                <label for="patient_name_query">Search the name of the patient</label>
                                <input class="form-control" type="search" name="patient_name_search_query">
                                <button type="submit" class="btn btn-primary btn-block" style="margin-top: 3%;">Search</button>
                            </div>
                        </form>
                    </div>
                    <div class="col-lg-3 col-md-12 col-sm-12"></div>
